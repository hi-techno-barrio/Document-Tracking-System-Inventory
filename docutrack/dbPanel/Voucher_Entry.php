...
$sql_ins=mysqli_query($conn,"INSERT INTO voucherstbl 
						VALUES(
						NULL,						
						'$Date_Received',
						'$Control_No' ,
...
$sql_update= mysqli_query($conn," UPDATE voucherstbl SET  
...
if($opr=="upd")
{
	$sql_upd=mysqli_query($conn,"SELECT * FROM voucherstbl WHERE voucherstbl_id=$id");
...
<div id="top_style">
       ...
       <div id="top_style_button"> 
       		<form method="post">
            	<a href="?tag=view_vouchers"><input type="button" name="btn_view" title="View Documents" value="Back" id="button_view" style="width:70px;"  /></a>
...
<div id="top_style">
       ...
       <div id="top_style_button"> 
       		<form method="post">
            	<a href="?tag=view_vouchers"><input type="button" name="btn_view" title="View Documets" value="View Documents" id="button_view" style="width:120px;"  /></a>
