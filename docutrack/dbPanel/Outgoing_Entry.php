...
if(isset($_POST['btn_sub'])){
				...
				$docType = $_POST['docType_txt'];
				$scanCopy = $_POST['scanCopy_txt'];
 		
$sql_ins = mysqli_query($conn," INSERT INTO outgoingtbl 
						VALUES(
						NULL,						
						'$Date_Received',
						'$Control_No' ,
					...
					");		
			if($sql_ins==true)
				echo "<fz>Profile added successfully</fz>";
			else
				echo "<ft>Invalid Profile ID</ft>";
...
if(isset($_POST['btn_upd'])){
					...
					$Care_off_by = $_POST['Care_off_by_txt'];
					$docType = $_POST['docType_txt'];
					$scanCopy_by = $_POST['scanCopy_txt'];
					
$sql_update=mysqli_query($conn," UPDATE outgoingtbl SET  
...
if($opr=="upd")
{
	$sql_upd=mysqli_query($conn,"SELECT * FROM outgoingtbl WHERE outgoingtbl_id=$id");
...
<div id="top_style">
       ...
       <div id="top_style_button"> 
       		<form method="post">
            	<a href="?tag=view_outgoing"><input type="button" name="btn_view" title="View Documents" value="View Document" id="button_view" style="width:70px;"  /></a>
           ...
           <tr>
            ...
            <tr>
			 ...
			 <tr>
            	<td>Document Type:</td>
            	<td>
                	<input type="text" name="docType_txt" id="textbox" value="<?php echo $rs_upd['docType'];?>" />
                </td>
            </tr>
			 <tr>
            	<td>Scan Copy:</td>
            	<td>
                	<input type="text" name="scanCopy_txt" id="textbox" value="<?php echo $rs_upd['scanCopy'];?>" />
                </td>
            </tr>
            <tr>
            	<td>Remarks:</td>
...
<div id="top_style">
       ...
       <div id="top_style_button"> 
       		<form method="post">
            	<a href="?tag=view_outgoing"><input type="button" name="btn_view" title="View Documets" value="View Documents" id="button_view" style="width:120px;"  /></a>
		...
		<div>
				  <table border="0" cellpadding="4" cellspacing="0">
						...
						<tr>
						 ...
						 <tr>
						  <td>Document Type:</td>
						  <td><input type="text" name="docType_txt" id="textbox"  required="required"/></td>
						</tr>
						 <tr>
						  <td>Scan Copy:</td>
						  <td><input type="text" name="scanCopy_txt" id="textbox"  required="required"/></td>
						</tr>
						<tr>
						  <td>Remarks:</td>
