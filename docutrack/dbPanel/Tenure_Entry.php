...
$sql_ins = mysqli_query($conn," INSERT INTO tenuretbl 
						VALUES(
						NULL,						
						'$Date_Received',
						'$Control_No' ,
...
$sql_update=mysqli_query($conn," UPDATE tenuretbl SET  
...
if($opr=="upd")
{
	$sql_upd=mysqli_query($conn,"SELECT * FROM tenuretbl WHERE tenuretbl_id=$id");
...
<div id="top_style">
       ...
       <div id="top_style_button"> 
       		<form method="post">
            	<a href="?tag=view_tenure"><input type="button" name="btn_view" title="View Documents" value="View Document" id="button_view" style="width:70px;"  /></a>
...
<div id="top_style">
       ...
       <div id="top_style_button"> 
       		<form method="post">
            	<a href="?tag=view_tenure"><input type="button" name="btn_view" title="View Documets" value="View Documents" id="button_view" style="width:120px;"  /></a>
