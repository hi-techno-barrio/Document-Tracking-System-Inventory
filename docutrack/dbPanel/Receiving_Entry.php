...
if(isset($_POST['btn_sub'])){
				...
				$Tobe = $_POST['To_txt'];
				$Received_by = $_POST['Received_by_txt'];
			
$sql_ins=mysqli_query($conn,"INSERT INTO receiving 
						VALUES(
						NULL,						
						'$Date_Received',
						'$Control_No' ,
			...
			if($sql_ins==true)
			{
				echo "<fz>Profile updated successfully</fz>";
			}	
			else{
...
$sql_update= mysqli_query($conn," UPDATE receiving SET  
...
if($opr=="upd")
{
	$sql_upd=mysqli_query($conn,"SELECT * FROM receiving WHERE receiving_id=$id");
...
<div id="top_style">
       ...
       <div id="top_style_button"> 
       		<form method="post">
            	<a href="?tag=view_receiving"><input type="button" name="btn_view" title="View Documents" value="Back" id="button_view" style="width:70px;"  /></a>
    	...
    	<div>
           ...
           <tr>
			...
			<tr>
            	<td>Received by:</td>
                <td>
                	<input type="text" name="Received_by_txt"  id="textbox" value="<?php echo $rs_upd['Received_by'];?> "/>
                </td>
            </tr>
...
<div id="top_style">
       ...
       <div id="top_style_button"> 
       		<form method="post">
            	<a href="?tag=view_receiving"><input type="button" name="btn_view" title="View Documets" value="View Documents" id="button_view" style="width:120px;"  /></a>
		...
		<div>
				  <table border="0" cellpadding="4" cellspacing="0">
						<tr>
						 ...
						 <tr>
						  <td>Received by:</td>
						  <td><input type="text" name="Received_by_txt"  id="textbox" required="required"/></td>
						</tr>
