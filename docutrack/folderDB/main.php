            ...
            <div id="contents">
				...
				<?php
						...
						//incoming 
                            ...
                            include("Incoming_Entry.php");
							
							elseif($tag=="view_incoming")
                            include("View_Incoming.php");
							
						//outgoing 	
							elseif($tag=="outgoing_entry")
                            include("Outgoing_Entry.php");
							
							elseif($tag=="view_outgoing")
                            include("View_Outgoing.php");
							
						//receiving 	
							elseif($tag=="receiving_entry")
                            include("Receiving_Entry.php");
							
							elseif($tag=="view_receiving")
                            include("View_Receiving.php");
							
						//apfc entry	
                            elseif($tag=="apfc_entry")
                            include("APFC_Entry.php");
							
							elseif($tag=="view_Tenure")
                            include("View_APFC.php");
							
						//tenure entry	
							elseif($tag=="Tenure_entry")
                            include("Tenure_Entry.php");
