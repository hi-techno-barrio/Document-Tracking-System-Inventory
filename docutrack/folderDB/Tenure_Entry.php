...
$sql_ins=mysqli_query($conn,"INSERT INTO package_tbl 
						VALUES(
							NULL,
							'$stu_id',
							'$pack' ,
...
if(isset($_POST['btn_upd'])){
	...
	$sql_update=mysqli_query($conn,"UPDATE package_tbl SET 
								stu_id='$stu_id' ,
								pack='$pack' , 
							    plength='$plength' , 
								pwidth='$pwidth' , 
...
if($opr=="upd")
{
	$sql_upd=mysqli_query($conn,"SELECT * FROM package_tbl WHERE package_id=$id");
